...
#############################################################################
{
    ...
    'description': 'Helps to know whether the sale price of any product less'
                   'than its cost price by getting an alert message, '
                   'At that message,when click on OK button, the validation '
                   'will continues and when it clicks on cancel button, '
